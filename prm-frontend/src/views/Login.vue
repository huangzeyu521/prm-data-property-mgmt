...
.login-wrap {
  ...
  background: linear-gradient(135deg, #0a2a66 0%, #126cfd 100%);
}
.login-card {
  width: 380px;
  background: #fff;
...
.login-csg { color: #126cfd; font-weight: 700; font-size: 15px; letter-spacing: 1px; }
.login-title { color: #262626; font-size: 18px; font-weight: 600; margin-top: 6px; }
.login-demo { margin-top: 14px; font-size: 12px; color: #8c8c8c; line-height: 1.8; }
