...
const routes = [
  ...
  { path: '/dpr/auth/scenario', name: 'AuthScenario', component: () => import('@/views/authorize/AuthScenario.vue'), meta: { title: '应用场景管理', category: 'SCENARIO' } },
  { path: '/dpr/auth/batch-list', name: 'AuthBatchList', component: () => import('@/views/authorize/AuthBatchList.vue'), meta: { title: '批量授权清单' } },
  ...
  { path: '/dpr/auth/agreement-template', name: 'AgreementTemplate', component: () => import('@/views/authorize/AgreementTemplate.vue'), meta: { title: '协议模板库管理', category: 'AGREEMENT_TEMPLATE' } },
