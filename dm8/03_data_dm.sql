...
('ARC-001','AST-001','客户用电信息表','数据持有权','广东电网','客户用电信息','确权认定','全网','数字化部',SYSDATE + INTERVAL '3' YEAR,'已确权','已授权','EC-PRA-0001',SYSDATE,0),
('ARC-002','AST-002','台区负荷数据','数据加工使用权','广东电网','台区负荷','确权认定','省内','数字化部',SYSDATE + INTERVAL '3' YEAR,'已确权','未授权','EC-PRA-0002',SYSDATE,0),
('ARC-003','AST-003','设备资产台账','数据持有权','深圳供电局','设备台账','确权认定','本单位','设备部',SYSDATE + INTERVAL '2' YEAR,'已确权','未授权','EC-PRA-0003',SYSDATE - INTERVAL '1' MONTH,0),
('ARC-004','AST-004','停电事件记录','数据加工使用权','深圳供电局','停电记录','确权认定','省内','调度中心',SYSDATE + 20,'已确权','已授权','EC-PRA-0004',SYSDATE - INTERVAL '2' MONTH,0),
('ARC-005','AST-005','电费账单明细','数据持有权','广西电网','电费明细','确权认定','本单位','财务部',SYSDATE + INTERVAL '3' YEAR,'待确权','未授权',NULL,SYSDATE - INTERVAL '3' MONTH,0),
('ARC-006','AST-006','充电桩运营数据','数据产品经营权','广东电网','充电运营','公司授权','对外开放','综能公司',SYSDATE + INTERVAL '2' YEAR,'已确权','已授权','EC-PRA-0006',SYSDATE - INTERVAL '12' MONTH,0),
('ARC-007','AST-007','气象环境数据','数据加工使用权','云南电网','气象数据','交易采购','省内','调度中心',SYSDATE + 10,'待确权','未授权',NULL,SYSDATE - INTERVAL '13' MONTH,0),
('ARC-008','AST-008','线损分析数据','数据持有权','贵州电网','线损数据','确权认定','本单位','运维部',SYSDATE + INTERVAL '3' YEAR,'已确权','未授权','EC-PRA-0008',SYSDATE - INTERVAL '14' MONTH,0);
...
('CHG-004','AST-006','确权','rightType','数据持有权','数据产品经营权','经营权确权认定','确权流程','QQ-0006','admin','d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5',SYSDATE,SYSDATE,0),
...
('CA-001','QQ-0001','AST-001','客户用电信息表','数据持有权','营销分析','广东电网','数字化部','已完成',80,1,'涉用户隐私,已取得授权','A','H',0,SYSDATE,0),
('CA-002','QQ-0002','AST-002','台区负荷数据','数据加工使用权','负荷预测','广东电网','数字化部','经理终审中',70,0,NULL,'A',NULL,0,SYSDATE,0),
('CA-003','QQ-0003','AST-003','设备资产台账','数据持有权','资产管理','深圳供电局','设备部','主管复核中',60,0,NULL,'A',NULL,0,SYSDATE,0),
('CA-004','QQ-0004','AST-005','电费账单明细','数据持有权','财务核算','广西电网','财务部','合规审核中',50,0,NULL,'E',NULL,0,SYSDATE,0),
('CA-005','QQ-0005','AST-007','气象环境数据','数据加工使用权','调度辅助','云南电网','调度中心','已驳回',NULL,0,'元数据质量评分 60 低于 80,自动驳回',NULL,NULL,0,SYSDATE,0),
('CA-006','QQ-0006','AST-006','充电桩运营数据','数据产品经营权','对外经营','广东电网','综能公司','草稿',NULL,1,'涉合作方商密,待补充许可','E','I',1,SYSDATE,0);
...
('CARD-001','EC-PRA-0001','CA-001','AST-001','客户用电信息表','数据持有权','广东电网','确权认定',SYSDATE + INTERVAL '3' YEAR,'正常',SYSDATE,0),
('CARD-002','EC-PRA-0002','CA-002','AST-002','台区负荷数据','数据加工使用权','广东电网','确权认定',SYSDATE + INTERVAL '3' YEAR,'正常',SYSDATE,0),
('CARD-003','EC-PRA-0003','CA-003','AST-003','设备资产台账','数据持有权','深圳供电局','确权认定',SYSDATE + INTERVAL '2' YEAR,'冻结',SYSDATE,0),
('CARD-004','EC-PRA-0006','CA-006','AST-006','充电桩运营数据','数据产品经营权','广东电网','公司授权',SYSDATE + INTERVAL '2' YEAR,'正常',SYSDATE,0),
('CARD-005','EC-PRA-0008','CA-001','AST-008','线损分析数据','数据持有权','贵州电网','确权认定',SYSDATE + INTERVAL '3' YEAR,'失效',SYSDATE,0);
...
('TPL-001','数据持有权证书模板','v1','数据资源持有权','生效中',SYSDATE,0),
('TPL-002','数据加工使用权证书模板','v1','数据加工使用权','生效中',SYSDATE,0),
('TPL-003','数据产品经营权证书模板','v1','数据产品经营权','停用',SYSDATE,0);
...
('CERT-001','QZ-PRA-0001','CARD-001','中国南方电网有限责任公司',SYSDATE,'生效','TPL-001','数据持有权证书模板',SYSDATE,0),
('CERT-002','QZ-PRA-0002','CARD-002','中国南方电网有限责任公司',SYSDATE,'生效','TPL-002','数据加工使用权证书模板',SYSDATE,0),
('CERT-003','QZ-PRA-0006','CARD-004','中国南方电网有限责任公司',SYSDATE,'已注销','TPL-003','数据产品经营权证书模板',SYSDATE,0);
...
('AITP-001','AITM-001','广东电网','客户用电信息','数据持有权','3年','全网','自行生产','个人隐私','有效',0.93,SYSDATE,0),
('AITP-002','AITM-002','广东电网','客户用电信息','数据加工使用权','2年','约定字段','公共授权','个人隐私','有效',0.88,SYSDATE,0);
...
('AITC-001','AITP-001','CA-001','产权类型','数据持有权','数据持有权','一致',SYSDATE,0),
...
('AITK-001','AST-001','广东电网','数据持有权','全网',SYSDATE + INTERVAL '3' YEAR,1,'自行生产','基于事实性描述',SYSDATE,0),
('AITK-002','AST-006','广东电网','数据产品经营权','对外开放',SYSDATE + INTERVAL '2' YEAR,0,'公司授权','涉合作方商密',SYSDATE,0),
('AITK-003','AST-006','某充电运营合作方','数据加工使用权','合作范围',SYSDATE + INTERVAL '2' YEAR,0,'合作约定','与经营权主张存在重叠',SYSDATE,0);
...
('EVID-0003','授权发证','ACERT-001','授权发证:广州供电局-数据加工使用权','c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4','0x7d6c5b4a39281706',100240,'已上链',SYSDATE,SYSDATE,0),
...
('AA-001','SQ-0001','一事一议','AST-001','客户用电信息表','EC-PRA-0001','广州供电局','数据加工使用权','电力金融征信','全字段',SYSDATE + INTERVAL '2' YEAR,'已生效',1,SYSDATE,0),
('AA-002','SQ-0002','一事一议','AST-002','台区负荷数据','EC-PRA-0002','深圳供电局','数据加工使用权','负荷预测','约定字段',SYSDATE + INTERVAL '2' YEAR,'合规审核中',0,SYSDATE,0),
('AA-003','SQ-0003','一事一议','AST-003','设备资产台账','EC-PRA-0003','南网科研院','数据加工使用权','设备健康分析','全字段',SYSDATE + INTERVAL '2' YEAR,'经理审核中',0,SYSDATE,0),
('AA-004','SQ-0004','批量','AST-006','充电桩运营数据','EC-PRA-0006','广东电网综能公司','数据产品经营权','对外经营','全字段',SYSDATE + INTERVAL '2' YEAR,'领导小组审批中',1,SYSDATE,0),
('AA-005','SQ-0005','批量','AST-008','线损分析数据','EC-PRA-0008','贵州电网','数据加工使用权','线损治理','约定字段',SYSDATE + INTERVAL '2' YEAR,'数字化部认定中',0,SYSDATE,0),
('AA-006','SQ-0006','一事一议','AST-004','停电事件记录','EC-PRA-0004','广西电网','数据加工使用权','停电分析','全字段',SYSDATE + INTERVAL '2' YEAR,'已驳回',0,SYSDATE,0);
...
('ACERT-001','AC-PRA-0001','AA-001','AST-001','广州供电局','数据加工使用权','全字段',SYSDATE + INTERVAL '2' YEAR,'生效',NULL,SYSDATE,0),
('ACERT-002','AC-PRA-0004','AA-004','AST-006','广东电网综能公司','数据产品经营权','全字段',SYSDATE + 20,'生效',NULL,SYSDATE,0),
('ACERT-003','AC-PRA-0008','AA-005','AST-008','贵州电网','数据加工使用权','约定字段',SYSDATE + INTERVAL '1' YEAR,'已暂停','监测联动熔断:越权调用',SYSDATE,0),
('ACERT-004','AC-PRA-0003','AA-003','AST-003','南网科研院','数据加工使用权','全字段',SYSDATE + INTERVAL '2' YEAR,'生效',NULL,SYSDATE,0);
...
('ATPL-001','专项授权-数据加工使用权证书模板','v1','专项授权证书','数据加工使用权','生效中',SYSDATE,0),
('ATPL-002','专项授权-数据产品经营权证书模板','v1','专项授权证书','数据产品经营权','生效中',SYSDATE,0),
('ATPL-003','批量授权-数据加工使用权证书模板','v1','批量授权证书','数据加工使用权','生效中',SYSDATE,0);
...
('AG-002','数据对外授权管理政策文件','政策文件','v1','公司总部',SYSDATE,'/files/对外授权政策.pdf',1,'依"三权分置",取得数据产品经营权的单位对外提供数据须签协议并向数字化部备案。',SYSDATE,0),
...
('AGT-001','运营授权协议(附录D)','运营','对外服务','甲乙双方就数据产品经营权授权达成协议:授权范围、期限、再授权限制、违约责任、数据安全义务等;对外提供数据须备案。','v1','生效中',SYSDATE,0),
...
('BA-001','BA-20260601001','AG-001','AA-001','广东电网','广州供电局','数据加工使用权','已备案',SYSDATE,SYSDATE,0),
('BA-002','BA-20260601002','AG-002','AA-004','广东电网综能公司','广东电网综能公司','数据产品经营权','待备案',NULL,SYSDATE,0),
('BA-003','BA-20260601003',NULL,'AA-005','贵州电网','贵州电网','数据加工使用权','待备案',NULL,SYSDATE,0);
