...
-- 由 MySQL 种子转换: NOW()→SYSDATE, DATE_ADD→INTERVAL
-- 执行:  disql PRM_DPR/PRM_DPR2024!@localhost:5236 @05_seed_aitool_dm.sql
-- ============================================================================
...
VALUES
  ('AITM-SEED-0001', 'BATCH-SEED01', NULL, 'AST-001-确权证明-盖好.pdf', 'PDF',
   ...
   '兹证明客户用电信息表由广东电网有限责任公司自行生产,权利类型为持有权,有效期3年,范围全字段,已盖章。',
   SYSDATE, 0);
...
VALUES
  ('AITP-SEED-0001', 'AITM-SEED-0001', '广东电网有限责任公司', '客户用电信息表', '持有权', '3年',
   '全字段', '自行生产', '个人信息', '有效', '正文含盖章表述,CV×OCR交叉校验通过',
   0.95, '自动通过', 88, '可信', SYSDATE, 0);
...
VALUES
  ('AITC-SEED-0001', 'AST-001', '深圳供电局', '所有权', '全字段',
   SYSDATE + INTERVAL '1' YEAR, 1, '历史确权', SYSDATE, 0),
  ('AITC-SEED-0002', 'AST-001', '广东电网有限责任公司', '持有权', '全字段',
   SYSDATE + INTERVAL '2' YEAR, 1, '当前申请', SYSDATE, 0);
...
VALUES
  ('AITX-SEED-0001', 'AST-001', '主体冲突', '历史确权',
   '客体 AST-001 被多主体声明持有类权利:深圳供电局(所有权,全字段,排他) 与 广东电网有限责任公司(持有权,全字段,排他)',
   '深圳供电局;广东电网有限责任公司', '高',
